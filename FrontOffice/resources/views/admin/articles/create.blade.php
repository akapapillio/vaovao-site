...
<head>
    ...
    <title>Créer un Article | Vaovao Site Admin</title>
    @vite(['resources/sass/app.scss', 'resources/js/app.js'])
    
    <!-- Script TinyMCE (Version Cloud gratuite pour démonstration) -->
...
<body class="bg-light">
    ...
    <main class="container bg-white p-4 shadow-sm rounded mb-5">
        ...
        <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-success px-5">Enregistrer l'Article</button>
            </div>
        </form>
    </main>
</body>
